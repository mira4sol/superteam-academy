...
import { PARTNERS } from '@/app/components/home/constants'
import { useTranslations } from 'next-intl'

export function SocialProofBar() {
  const t = useTranslations('home')
  return (
    <div className='bg-[var(--landing-cream-dark)] px-4 sm:px-[5%] overflow-hidden'>
        ...
        <div className='overflow-hidden flex-1 min-w-0'>
          <div className='landing-animate-marquee flex gap-4 w-max'>
            {[...PARTNERS, ...PARTNERS].map((p, i) => (
              ...
              >
                <div className='w-[22px] h-[22px] rounded-[5px] bg-[var(--landing-secondary)] flex items-center justify-center text-[9px] font-black text-[var(--landing-cream)] font-[inherit]'>
                  {p.abbr}
                </div>
