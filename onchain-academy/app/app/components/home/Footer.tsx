...
export function Footer({
  ...
  return (
    <footer className='bg-[var(--landing-charcoal)] py-12 sm:py-16 md:py-20 px-4 sm:px-[5%] pb-8'>
      <div className='max-w-[1200px] mx-auto'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] gap-8 sm:gap-10 mb-10 sm:mb-14'>
          <div>
            <div className='font-display text-xl sm:text-[22px] text-[var(--landing-cream)] mb-3.5'>
              Superteam{' '}
              <span className='text-[var(--landing-accent)]'>Academy</span>
            </div>
              ...
              {!subscribed ? (
                ...
                >
                  ...
                  <input
                    ...
                    className='flex-1 py-2.5 px-3.5 rounded-t-[7px] sm:rounded-l-[7px] sm:rounded-tr-none sm:rounded-br-none bg-[rgba(247,234,203,0.07)] border border-[rgba(247,234,203,0.15)] sm:border-r-0 text-[var(--landing-cream)] text-[13px] outline-none font-[inherit] min-w-0'
                  />
                  <button
                    type='submit'
                    className='bg-[var(--landing-primary)] text-[var(--landing-cream)] py-2.5 px-4 rounded-b-[7px] sm:rounded-r-[7px] sm:rounded-tl-none sm:rounded-bl-none border-none text-[13px] font-semibold cursor-pointer font-[inherit] whitespace-nowrap'
                  >
              ...
              {socialLinks.map((s) => {
                ...
                return (
                  <a
                    ...
                    title={s.label}
                    className='w-9 h-9 rounded-lg bg-[rgba(247,234,203,0.07)] border border-[rgba(247,234,203,0.12)] flex items-center justify-center text-[rgba(247,234,203,0.45)] transition-all shrink-0 hover:bg-[rgba(247,234,203,0.13)] hover:text-[var(--landing-cream)] hover:border-[rgba(247,234,203,0.25)]'
                    aria-label={s.label}
                  >
                ...
                <ul className='list-none flex flex-col gap-2.5'>
                  {links.map((l) => (
                    <li key={l}>
                      <Link
                        href='/'
                        className='text-[13px] text-[rgba(247,234,203,0.55)] no-underline transition-colors font-[inherit] hover:text-[var(--landing-cream)]'
                      >
                        {l}
                      </Link>
                    </li>
