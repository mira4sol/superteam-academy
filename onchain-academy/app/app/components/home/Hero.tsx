...
import { STATS } from '@/app/components/home/constants'
...
export function Hero() {
  ...
  return (
    <section className='landing-hero-bg min-h-screen pt-[68px] relative overflow-hidden flex items-center pb-8 md:pb-0'>
      ...
      <div className='max-w-[1200px] mx-auto py-10 sm:py-16 md:py-20 px-4 sm:px-[5%] relative z-[2] w-full'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center'>
          <div className='order-2 md:order-1'>
            <div className='landing-animate-fade-up inline-flex items-center gap-2 bg-[rgba(255,210,63,0.1)] border border-[rgba(255,210,63,0.25)] text-[var(--landing-accent)] py-1.5 px-3.5 rounded-full text-[10px] sm:text-[11px] font-bold tracking-[0.08em] uppercase mb-5 sm:mb-7 font-[inherit]'>
              <span className='landing-animate-pulse-dot w-1.5 h-1.5 rounded-full bg-[var(--landing-accent)] inline-block' />
              {t('hero.badge')}
            </div>
            <h1 className='font-display landing-animate-fade-up-d1 text-[clamp(2rem,8vw,4.4rem)] sm:text-[clamp(2.8rem,5vw,4.4rem)] leading-[1.08] text-[var(--landing-cream)] mb-4 sm:mb-6 font-black'>
              {t('hero.h1a')}{' '}
            ...
            <div className='landing-animate-fade-up-d3 flex flex-wrap gap-3 mb-8 sm:mb-12'>
              <button
                type='button'
                className='landing-btn-primary py-3.5 px-8 rounded-lg text-[15px] font-bold cursor-pointer font-[inherit] border-none'
              >
                {t('hero.cta1')}
              </button>
              <button
                type='button'
                className='landing-btn-outline-cream py-3.5 px-7 rounded-lg text-[15px] font-semibold cursor-pointer font-[inherit]'
              >
                {t('hero.cta2')}
              </button>
            </div>
            <div className='landing-animate-fade-up-d4 grid grid-cols-2 md:flex gap-4 md:gap-0 pt-6 sm:pt-8 border-t border-[rgba(247,234,203,0.08)]'>
              {STATS.map((s, i) => (
                ...
                >
                  <div className='font-display text-xl sm:text-[26px] text-[var(--landing-cream)] leading-none mb-0.5'>
                    {s.value}
                  </div>
          ...
          <div className='relative min-h-[380px] md:h-[540px] order-1 md:order-2'>
            ...
            <div className='landing-card-border absolute top-0 left-0 right-0 md:top-[4%] md:left-[2%] md:right-[2%] rounded-2xl overflow-hidden bg-[rgba(13,31,18,0.85)] border border-[rgba(0,140,76,0.25)] backdrop-blur-[20px] mx-2 md:mx-0'>
              ...
              <div className='py-4 px-4 sm:py-5 sm:px-6 pb-5 sm:pb-6'>
                ...
                <h3 className='font-display text-[17px] sm:text-[21px] text-[var(--landing-cream)] mb-1.5 sm:mb-2 leading-tight tracking-tight'>
                  {t('hero.cardTitle')}
                </h3>
                ...
                <div className='flex flex-col gap-0'>
                  {[
                    ...
                    >
                      ...
                      <span
                        className={`text-xs font-[inherit] flex-1 ${
                          m.done
                            ...
                            : m.active
                              ? 'text-[var(--landing-cream)] font-semibold'
                      ...
                      {m.active && (
                        <span className='text-[9px] font-bold text-[var(--landing-primary)] tracking-[0.06em] uppercase font-[inherit]'>
                          {t('hero.activeLabel')}
                        </span>
                      )}
                    </div>
            ...
            <div className='hidden sm:block landing-animate-float-fast absolute bottom-[10%] -right-[4%] bg-gradient-to-br from-[var(--landing-accent)] to-[#f0c22e] text-[var(--landing-charcoal)] py-[11px] px-4 rounded-[14px] font-[inherit] shadow-[0_8px_32px_rgba(255,210,63,0.45),0_2px_8px_rgba(0,0,0,0.3)] z-[4]'>
            ...
            <div className='hidden sm:flex landing-animate-float-slow absolute bottom-[30%] -left-[6%] bg-[rgba(13,31,18,0.9)] border border-[rgba(82,221,160,0.25)] backdrop-blur-[12px] py-2.5 px-3.5 rounded-xl items-center gap-2 font-[inherit] shadow-[0_8px_24px_rgba(0,0,0,0.4)] z-[4] whitespace-nowrap'>
              <div className='w-[30px] h-[30px] rounded-lg bg-[rgba(255,210,63,0.12)] border border-[rgba(255,210,63,0.2)] flex items-center justify-center'>
                <Flame
                  size={14}
                  className='text-[var(--landing-accent)] shrink-0'
                  strokeWidth={2}
                />
              </div>
              <div>
                <div className='text-[13px] font-bold text-[var(--landing-cream)] leading-none'>
                  {t('hero.streak')}
                </div>
      ...
      <div className='absolute bottom-0 left-0 right-0 h-[120px] pointer-events-none bg-gradient-to-b from-transparent from-0% via-[var(--landing-hero-bg)] via-60% to-[var(--landing-cream-dark)]' />
      <svg
        className='absolute -bottom-px left-0 right-0 w-full h-[60px]'
        viewBox='0 0 1440 60'
        preserveAspectRatio='none'
        fill='var(--landing-cream-dark)'
      >
